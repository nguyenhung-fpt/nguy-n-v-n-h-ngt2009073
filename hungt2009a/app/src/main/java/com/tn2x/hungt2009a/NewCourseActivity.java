...
public class NewCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra(EXTRA_ID)) {
            ...
            courseNameEdt.setText(intent.getStringExtra(EXTRA_NAME));
            courseDescEdt.setText(intent.getStringExtra(EXTRA_DESCRIPTION));
            courseDurationEdt.setText(intent.getStringExtra(EXTRA_EMAIL));
        }
    ...
    private void saveCourse(String courseName, String courseDescription, String courseDuration) {
        ...
        data.putExtra(EXTRA_EMAIL, courseDuration);
